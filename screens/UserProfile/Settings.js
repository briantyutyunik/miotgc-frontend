			...
			<View style={styles.settingsScreenContainer}>
				...
				<CardDarker additionalStyles={styles.cardStyle}>
					...
					<View style={styles.rowContainer}>
						...
						<CustomPicker selectedValue={language} onValueChange={setLanguage} items={languages} style={styles.picker} />
					</View>
					<Separator />

					<View style={styles.rowContainer}>
						<Text style={styles.label}>Currency</Text>
						<CustomPicker selectedValue={currency} onValueChange={setCurrency} items={currencies} style={styles.picker} />
					</View>
					<Separator />
