...
import { pickImageFromCamera, pickImageFromLibrary } from "../../util/ImageUtils";
import { auth, generateImageName, updateUser, uploadImage } from "../../firebase";
import User from "../../models/User";

//import to show social icons

export default function ImageSelect({ openImageSelect, setOpenImageSelect, setImage }) {
				...
				<View style={styles.overlay}>
					<View style={styles.bottomSheet}>
						<View style={styles.bottomSheetHeader}>
							<TouchableOpacity style={styles.bottomSheetHeaderButton} onPress={handleCancelPress}>
								<Ionicons name="md-close" size={24} color="gray" />
							</TouchableOpacity>
							<Text style={styles.bottomSheetHeaderText}>Select a Photo</Text>
						</View>
						<TouchableOpacity style={styles.bottomSheetOption} onPress={handleCameraRollPress}>
							<Ionicons name="ios-images" size={24} color="gray" />
							<Text style={styles.bottomSheetOptionText}>Camera Roll</Text>
						</TouchableOpacity>
						<TouchableOpacity style={styles.bottomSheetOption} onPress={handleCameraPress}>
							<Ionicons name="ios-camera" size={24} color="gray" />
							<Text style={styles.bottomSheetOptionText}>Take Photo</Text>
						</TouchableOpacity>
						<TouchableOpacity style={styles.bottomSheetOption} onPress={handleCancelPress}>
